        ...
        <div class='row mt-2'>
            <div class="col-12">
                ...
                <form action="/clothes/<?php echo e($clothe->id); ?>" method="post">
                    ...
                    <textarea name="description" class='form-control' cols="30" rows="10"><?php echo e($clothe->description); ?>
...
<?php endif; ?><?php /**PATH D:\domaci\laravel domaci\gotovo\odeca\resources\views/updateClothe.blade.php ENDPATH**/ ?>